...
"""
        self.wfile.write(yadis_text.encode() % (discover.OPENID_2_0_TYPE, discover.OPENID_1_0_TYPE,
...
"""
        self.wfile.write(seryadis_text.encode() % (discover.OPENID_IDP_2_0_TYPE, endpoint_url,))
...
'''
        self.wfile.write((page_text % contents).encode())
